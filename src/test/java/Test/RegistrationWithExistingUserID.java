...
public class RegistrationWithExistingUserID {
	WebDriver driver;
    ...
    public void testUserRegistration() throws InterruptedException {
    	...
    	ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("extent.html");
	  	 ExtentReports extent = new ExtentReports();
	  	  ...
	  	  ExtentTest test = extent.createTest("Verifying Registration With Existing User ID", "Checking Registration With Existing User ID");
