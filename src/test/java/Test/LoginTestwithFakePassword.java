...
public class LoginTestwithFakePassword {
  ...
  public void f() throws InterruptedException {
	  ...
	  ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("extent.html");
	  	 ExtentReports extent = new ExtentReports();
	  	  ...
	  	  ExtentTest test = extent.createTest("Verifying Logging Test with Fake password", "Checking Logging Test with fake password");
		...
		Thread.sleep(1500);
		signIn.enterPassword().sendKeys("testpasasdfsword");
		Thread.sleep(1500);
